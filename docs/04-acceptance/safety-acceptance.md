...
| SAF-003 | Source-retirement requires hash verification and explicit approval. | Inspect live migration and rollback docs. | Approval record template, verification steps. | BLOCKER | Live migration playbook |
...
| SAF-006 | No live NAS mutation is authorized in blueprint mode. | Read status, playbooks, and handoff docs. | Acceptance docs, project status. | BLOCKER | Governance docs |
